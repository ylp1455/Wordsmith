    ...
    <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Have questions about Wordsmith? We're here to help. Reach out to our team and we'll get back to you as soon as possible.
        </p>
      </div>
            ...
            <div className="p-6 space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Our team is ready to assist you with any questions or concerns you may have about Wordsmith.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@wordsmith.com</p>
      ...
      <div className="mt-16 text-center">
        ...
        <p className="text-gray-600 mb-8">
          Find quick answers to common questions about Wordsmith.
        </p>
        <a 
          href="/faq" 
